      ...
      <div class="function_area" v-show="active_type=='chat'">
        ...
        <div class="chat_area">
          ...
          <div class="message_send">
            ...
            <div class="send_btn" @click="submitMessage()">发送</div>
  ...
  export default {
    ...
    mounted() {
      ...
      socket.on('chatBackSelf', data => {
        ...
        this.messageList[index].message_list.push(message);
        this.syncToLocal();
      })
      ...
      selectBottomSheet(type) {
        switch (type) {
          case "chat":
            ...
            this.message = "";
            this.active_chat = this.friendList[this.bottomNowIndex].user_name;
            //观察是否已经存在活动的对话列表
